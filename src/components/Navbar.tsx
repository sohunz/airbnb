        ...
        {!condition ? (
          ...
          <div className="justify-self-center">
            <div className="flex gap-1 align-middle">
              <button className="hover:bg-gray-100 py-3 px-5 rounded-full">Stay</button>
              <button className="hover:bg-gray-100 py-3 px-5 rounded-full">Experiances</button>
              <button className="hover:bg-gray-100 py-3 px-5 rounded-full">Online Experiances</button>
            </div>
          </div>
        )}
